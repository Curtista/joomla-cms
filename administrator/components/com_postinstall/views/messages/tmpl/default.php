...
<div class="hero-unit">
	...
	<a href="index.php?option=com_postinstall&amp;view=messages&amp;task=message.reset&amp;eid=<?php echo $this->eid; ?>&amp;<?php echo $this->token; ?>=1" class="btn btn-warning btn-large">
...
<?php endif; ?>
	...
	<fieldset>
		...
		<div>
			...
			<a href="index.php?option=com_postinstall&amp;view=messages&amp;task=message.action&amp;id=<?php echo $item->postinstall_message_id; ?>&amp;<?php echo $this->token; ?>=1" class="btn btn-primary">
